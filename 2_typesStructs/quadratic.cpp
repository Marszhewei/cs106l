...
int main() {
    ...
    auto root = quadratic(a, b, c);
    if (std::get<0>(root)) {
        std::cout << "root1 is: " << std::get<0>(std::get<1>(root)) << std::endl;
        std::cout << "root2 is: " << std::get<1>(std::get<1>(root)) << std::endl;
    } else {
        std::cout << "no roots\n";
    }
    ...
    if (found) {
        std::cout << "root1 is: " << solutions.first << std::endl;
        std::cout << "root2 is: " << solutions.second << std::endl;
    } else {
        std::cout << "no roots\n";
    }
